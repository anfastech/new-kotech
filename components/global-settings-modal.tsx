...
import { MapPin, Crosshair, Target, Eye, EyeOff, Route, RotateCcw } from "lucide-react"
...
const getVehicleCount = (type: string, vehicles: any[]) => {
                ...
                <div key={type} className="flex items-center justify-between p-2 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-2">
                    ...
                    <Badge variant="secondary" className="text-xs">
                      {getVehicleCount(type, vehicles)}
                    </Badge>
                  </div>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => onLayerToggle(type as any, !visible)}
                  >
